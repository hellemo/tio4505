...
# ╔═╡ 5a9c9818-6b9b-11eb-2930-87455b89c53f
using ShortCodes

# ╔═╡ 1d051f56-7376-11eb-04dc-0dbb46ad9a15
using Colors

# ╔═╡ c04abb67-46a0-4b6f-9919-a60619a1a44d
using PlutoUI

# ╔═╡ 8b632e0e-6ba9-11eb-09e2-219a50ec808b
using LinearAlgebra

# ╔═╡ 2cd10dc4-6e07-11eb-347d-a1569f8f2c6b
using DifferentialEquations, ParameterizedFunctions

# ╔═╡ d093e235-2809-4c08-b36b-774b5a5da47f
using WGLMakie

# ╔═╡ 6bf15128-6fd3-11eb-33f3-3b632ab2fc05
using AbstractTrees

# ╔═╡ de75c75c-6b9a-11eb-38fe-0d7fee4bfdb7
html"<button onclick=present()>Present</button>"

# ╔═╡ f1abf7e0-6b9a-11eb-3674-71687f65ad47
html"""<img src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Julia_Programming_Language_Logo.svg" width=400 />"""

# ╔═╡ 0f9ce884-6c51-11eb-14d4-a1282928957e
html"""<img src="https://julialang.org/assets/images/benchmarks.svg" width=800 />"""

# ╔═╡ 2dce817e-7056-11eb-3243-c9c799ac4e1f
2+2 # Calculation

# ╔═╡ bb97a456-6e0b-11eb-0627-5f6493a7ff44
typeof.([1, 1.0, "Hei", 1//2, π])

# ╔═╡ 232d27ca-7376-11eb-2c52-07ad4f836481
[RGB(r, 0, 0) for r ∈ 0:0.1:1]

# ╔═╡ b1264510-2fc6-44f5-bbd5-7102d25d16f1
@bind gran PlutoUI.Scrubbable(0.3)

# ╔═╡ adcc24e4-737b-11eb-21bf-2d58598865a5
[RGB(r, 0, b) for r ∈ 0:gran:1, b ∈ 0:gran:1]

# ╔═╡ cd18abf6-737b-11eb-2bf3-b103a35d822c
Dump(RGB(1,0,0))

# ╔═╡ 623c5208-6e0b-11eb-34bb-f1fb6dd1d71c
# f(x::String) = "Hello, $x"

# ╔═╡ d01b247e-6ba5-11eb-3287-7ba43e390259
YouTube("qLO-yaUkLKE",26,12) # Intro to Julia

# ╔═╡ 19416f4e-7382-11eb-3600-9980a412e545
YouTube("3zTO3LEY-cM",2,43) # MIT Computational Thinking Course

# ╔═╡ 4a75def6-75ee-11eb-03f2-b3867bd539d7
YouTube("6JcMuFgnA6U",7,27) # High Performance in Dynamic Languages

# ╔═╡ 356c9a0d-dc02-45dd-b62d-51a2d809a7b4
YouTube("mSgXWpvQEHE", 21, 55)

# ╔═╡ 2db916d0-6ba7-11eb-35de-75eea34611e6
YouTube("kc9HwsxE1OY",3,47) # The Unreasonable Effectiveness of Multiple Dispatch

# ╔═╡ f64e87ee-737f-11eb-051b-f5cc6b1dba0f
greet(x, y) = "$x greets $y"

# ╔═╡ c4644fa2-737f-11eb-1393-b79c6354b0b1
struct Person
	name::String
end

# ╔═╡ f11679d0-737f-11eb-1ebb-2b7f228fb7b9
begin
	alice = Person("Alice")
	bob = Person("Bob")
end

# ╔═╡ 220f2e42-7380-11eb-1bf6-0bcdb2a09e8c
# greet(x::Person, y::Person) = "$(x.name) hugs $(y.name)"

# ╔═╡ ef9d2ec6-737f-11eb-1a82-736327672b56
begin
...
# ╔═╡ 570d97dc-7380-11eb-385d-9703ab6daa73
greet(x::Person, y::Animal) = "$(x.name) pats $(y.name)"

# ╔═╡ fbcc7fd6-7380-11eb-1b59-1b6bf55c05e7
greet(x::Cat, y::Person) = "$(x.name) meows at $(y.name)"

# ╔═╡ 0583b45e-7381-11eb-0db3-ab3bbd75d541
struct Car end

# ╔═╡ 113de19a-7381-11eb-135d-4b317b77ae11
greet(x::Car, y) = "Car honks!"

# ╔═╡ 28dc787e-7380-11eb-00f6-73180ab62b77
greet("Alice","Bob")

# ╔═╡ 0ab25f94-7380-11eb-1dd4-e51a8d873ec7
greet(alice, bob)

# ╔═╡ c6393134-7380-11eb-21ab-f3ecf58c3933
greet(alice, Cat("Spot"))

# ╔═╡ f1e65618-7380-11eb-3524-0fa30905f12c
greet(Cat("Spot"), bob)

# ╔═╡ 25b05d86-7381-11eb-3b12-f9d326dee362
[greet(Car(), y) for y in [Cat("Spot"), Dog("Rex"), Person("Lisa")]]

# ╔═╡ a66336d3-f5b9-4146-a2cf-ed1d1da2d242
begin
...
# ╔═╡ 2f7e5daa-bfc1-4f9a-9085-c6d2e57cf979
play(👋, 👊)

# ╔═╡ 846d52d6-1e6d-46fe-9498-f30573aae9f5
play(👊,👊)

# ╔═╡ 092f6e10-98e1-4e4c-af29-f641ff0c6a4b
play(✌️, 👋)

# ╔═╡ 2925554d-ad76-4bef-826b-0bc185e1c16c
play(rand([👋, 👊, ✌️]), 
	 rand([👋, 👊, ✌️]))

# ╔═╡ c31b65ea-6baa-11eb-3c55-893480a9831d
A = rand(3, 3)

# ╔═╡ c852d660-6baa-11eb-1b7d-5583c5bdc4ba
vs = [rand(3) for _ = 1:4]

# ╔═╡ 1f3719be-6bab-11eb-3a76-41a18c6f7ef0
import Base: size, getindex, *

# ╔═╡ 7985144e-6b9b-11eb-0c3c-31c0d4d974fc
f(x) = 5x + 10 # functions (short form)

# ╔═╡ 85a80a4c-6b9b-11eb-367b-435841a3128e
f(1.0)

# ╔═╡ 3a2834ba-6b9c-11eb-3a49-97de18133485
f(1)

# ╔═╡ 54a38a1c-6e0b-11eb-2fe4-45f04d7cc754
f("SINTEF")

# ╔═╡ 23f55f7c-6ea0-11eb-161b-6b038aa58769
methods(f)

# ╔═╡ 9ef6df50-6baa-11eb-28d2-c97ade659b7c
inner(v, A, w) = dot(v, A * w) 

# ╔═╡ b0101b96-737d-11eb-146b-53e497b7e445
A*[1,0, 0]

# ╔═╡ 29b1b764-6bab-11eb-3ec7-fd2f9173b528
struct OneHotVector <: AbstractVector{Bool}
	len::Int
	ind::Int
end

# ╔═╡ 45e6d068-6bab-11eb-1269-956ed19ab873
Base.size(v::OneHotVector) = (v.len,)

# ╔═╡ 62808de0-6bab-11eb-21b2-4f9d30fc5c6b
Base.getindex(v::OneHotVector, i::Integer) = i == v.ind

# ╔═╡ 60712cbe-78e0-11eb-34d2-6f33a2e8dbbb
md" Check before presenting: 
* Use Firefox with [uBlock to avoid YouTube pause overlay](https://www.reddit.com/r/firefox/comments/61y7lf/how_to_removedisable_more_videos_when_pausing_an/)
* Disable tracking prevention to show embedded Tweets"

# ╔═╡ 26962dcc-6b9b-11eb-0813-8b1f81f8284a
md"# "

# ╔═╡ ed9fd37e-6b9a-11eb-0af5-19a574538450
md"### 2021-05-11, Lars Hellemo
[https://stash.code.sintef.no/users/lhellemo/repos/slides_2021-05-11_julia-intro-ocean/browse](https://stash.code.sintef.no/users/lhellemo/repos/slides_2021-05-11_julia-intro-ocean/browse)"

# ╔═╡ 7afbc708-6e09-11eb-105f-4d265e8e8472
md" # Julia in a Nutshell
* Modern dynamic, high-level language
  - First public release in 2012, version 1.0 released in 2018
  - **Multiple Dispatch**
  - Metaprogramming
  - Free (MIT licence)
* Julia is a great choice for scientific computing:
  - Excellent performance (LLVM)
  - N-dimensional arrays
  - Parallel and distributed computing
  - Reproducible environment
"

# ╔═╡ 49cadbc6-6b9b-11eb-386e-196e3c94b32e
md" # Why Julia?
[https://julialang.org/benchmarks/](https://julialang.org/benchmarks/)"

# ╔═╡ 473aea76-6fd4-11eb-3325-6f032f2e29fc
...
# ╔═╡ 51961f32-6b9b-11eb-3b88-63ec62cbb0f2
md" # A taste of Julia"

# ╔═╡ a64addaa-6ba6-11eb-2490-9353080f4830
md"# A longer intro.."

# ╔═╡ 017c86ac-6ba6-11eb-1876-6b891c84b806
md"# Multiple Dispatch"

# ╔═╡ c01fb364-737f-11eb-15a2-f701efadc34b
md"# Multiple Dispatch (Pets)"

# ╔═╡ ba3a23c3-c3ce-4604-bc93-92abb6cc20e6
md"# 👊, ✌️, 👋
...
# ╔═╡ 47dff9ea-6bf0-11eb-01e9-5719e5d2928a
md"# Multiple Dispatch (Linear Algebra)"

# ╔═╡ 8c7b721e-6bf0-11eb-0ce7-df1381d79d91
md"## Custom type: OneHotVector"

# ╔═╡ d11539a8-6bef-11eb-1f96-4f8742aae7da
OneHotVector(3,3).*1

# ╔═╡ 8d285e06-6bab-11eb-3933-2576b30eda57
vs₁ = [OneHotVector(3, rand(1:3)) for _ = 1:4]

# ╔═╡ ba11e3d4-6bb4-11eb-1aae-a7ca2ce0c1ca
A

# ╔═╡ aec75284-6bb4-11eb-3b45-e7627eb4ce06
dot([1,0,0], A*[0,1,0]) # Corresponds to selecting col/row from A

# ╔═╡ bf657202-6e06-11eb-3148-59b0fdbaeb10
md"Multiple dispatch in action: dispatch on both first and third argument:"

# ╔═╡ 5dce7e46-6bac-11eb-0653-2354eaab7b90
inner(v::OneHotVector, A, w::OneHotVector) = A[v.ind, w.ind]

# ╔═╡ 91b44220-6ba9-11eb-2a94-cb47d0daa318
...
# ╔═╡ d98e2d9e-6baa-11eb-12c5-13f05b4b1c85
inner_sum(A, vs)

# ╔═╡ b86e420e-6bab-11eb-1c3c-89010f379325
inner_sum(A,vs₁)

# ╔═╡ 70d1bd14-6bac-11eb-0117-45b74fdd87d8
inner_sum(A,vs₁)

# ╔═╡ 8bce5564-6c47-11eb-09b3-f3c661362fb1
B = [1//1 1//2 1//3
	 1//3 1//2 1//4
	 1//1 1//2 1//5]

# ╔═╡ e0934634-6e06-11eb-1f44-1bae7ae4eab5
md" Dispatch on type of second argument as well:"

# ╔═╡ 5f77f620-6c47-11eb-2f46-bd452c365c7d
inner_sum(B,vs₁)

# ╔═╡ 455a9876-78e6-11eb-30c5-f9c4301f18aa
md"# Automatic Differentiation"

# ╔═╡ 18a02bce-78e7-11eb-3112-a356e9db243f
md" Demo in separate notebook if time allows (ask in Q&A), writing a simple AD in 8-10 LOC"

# ╔═╡ b14201de-78e9-11eb-0975-d3b6606329f6
WebPage("https://juliadiff.org/")

# ╔═╡ fed1c490-6e06-11eb-35a6-316f065ce83d
md"# DifferentialEquations.jl"

# ╔═╡ 88850d47-83e8-4679-a87b-82764d4b2322
#using Plots

# ╔═╡ 398a094e-6e07-11eb-2094-2145b063dac7
...
# ╔═╡ 414e631e-6e07-11eb-3eb9-79ed083a99bc
function ode_demo(lorenz, u0 = [1.,1.,1.], tspan = (0.,60.), p = [10.,28.,8/3])
	prob = ODEProblem(lorenz, u0, tspan, p)  # define the problem
	sol0 = solve(prob, reltol=1e-9) 
end

# ╔═╡ 4a5043d0-6e07-11eb-1ff7-a9a1f5b28042
u₂=1.0;u₃=1.0

# ╔═╡ 575e958e-6e07-11eb-20da-1d9aaeb43f5f
@bind u₁ PlutoUI.Slider(0:0.01:1.5;default=1.0)

# ╔═╡ 60623e24-6e07-11eb-321d-7176fb029f3d
sol0 = ode_demo(lorenz, [u₁,u₂,u₃],(0.,50.))

# ╔═╡ eea73340-aa95-4867-adc3-6d440f3ea09a
lines(sol0, color="blue", axis = (; type = Axis3,  
              viewmode = :fit, ))


# ╔═╡ 66e1b824-6e07-11eb-1aad-9937d7f121a0
#plot(sol0, vars = (1, 2, 3)) 

# ╔═╡ 6922c824-6e07-11eb-0044-5f9241616e80
#plot(sol0, vars = (2, 3))

# ╔═╡ 03c2ed8e-6ba6-11eb-0b53-97232628c3ab
md" # Celeste.jl | >1 PetaFLOPS"

# ╔═╡ 0a4eae90-6ba6-11eb-2303-071f5be8b35f
YouTube("uecdcADM3hY",7,20)

# ╔═╡ 0eb2e668-6ba6-11eb-0942-23960d804540
Twitter(1353102345291390979)

# ╔═╡ 1dfcbc50-6fd6-11eb-0755-75f0bb3b89f4
md"# Oceanigans.jl
[https://github.com/CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl)"	

# ╔═╡ f3f2bd48-7883-11eb-0807-13afc5d6f904
Twitter(1324042801399607296)

# ╔═╡ da11ba10-a863-4901-9d87-ae2b9546bd0a
Twitter(1377221822907813894)

# ╔═╡ 2aab5b46-6fd6-11eb-0e64-8bf03a97a921
YouTube("kpUrxnKKMjI")

# ╔═╡ f26d53d6-ca94-4c19-8d7c-d433bdd3fab3
md"# Reproducibility"

# ╔═╡ f642665f-bb5c-452c-ad13-5f3fd1ecd7e1
	# with_terminal() do
	# 	Pkg.activate(@__DIR__) # Environment at notebook file location in this case
	# 	Pkg.instantiate()	   # Load exact same versions of dependencies
	# end

# ╔═╡ 20069423-4eb3-4bc6-9514-e77111dd8673
# with_terminal() do
# 	Pkg.status()
# end

# ╔═╡ 62b906e2-78f4-11eb-0933-b9d35dd3ee36
md"# Happy Hacking"

# ╔═╡ 70980dee-78f4-11eb-0241-ab31e9c19317
WebPage("https://julialang.org/downloads/#current_stable_release")

# ╔═╡ 40deb334-6fd3-11eb-13e3-436693fc0b5c
md"# SINTEF
...
manifest_format = "2.0"
project_hash = "8ba051a7e949bd9c1a78e96196d71900516aebb9"
