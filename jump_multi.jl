...
# ╔═╡ 5a486b40-4b26-11ee-120f-afe9d973e917
using JuMP, HiGHS, MultiObjectiveAlgorithms, Plots

# ╔═╡ 3ad117ea-e18e-4375-8888-6565018e2199
html"<button onclick=present()>Present</button>"

# ╔═╡ 8a8ee2a1-a38a-460d-a1e0-73128416a298
md"# Multiobjective optimization"

# ╔═╡ 3c59bca9-7879-4140-a93a-180d5cb78a29
md"Extend the knapsack problem with an extra dimension"

# ╔═╡ 11265855-4174-425f-8ff2-70ceee7110b9
begin
...
# ╔═╡ 444184fd-cb85-41ac-802b-5d5383efad6e
md"Setting up the model in JuMP with two objectives"

# ╔═╡ 69779c5e-9ea8-450d-942a-03fb45dff823
begin
	model = Model()
...
# ╔═╡ ca7b3dc0-8bb0-4d0c-b61c-e55fb004630d
md"### Solution"

# ╔═╡ 796e0f4c-56c8-4897-ab3f-991278f37ef5
begin
...
# ╔═╡ 5b681ded-1086-45e1-8c3f-7222f93b4870
begin
	plot = Plots.scatter(
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a26ed4e172ad490d095f346cde1ee95058bad00f"
...
git-tree-sha1 = "d99856aca359b86a35b071d787f722a8b91ebd3b"
