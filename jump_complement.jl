...
# ╔═╡ a76629ee-a679-425d-9153-791b407b43ac
using JuMP, PATHSolver, DataFrames

# ╔═╡ f1f58bc0-4b1d-11ee-17b9-cbde4897a285
html"<button onclick=present()>Present</button>"

# ╔═╡ 1664c9b9-1d77-4db7-b21e-39394bd49de2
md"# Mixed complemantarity problem"

# ╔═╡ 3ef793aa-517e-4d41-aaff-54bedad61504
md"A mixed complementarity problem has the form:
```math
\begin{align}
...
# ╔═╡ a5cf57cd-080a-4a7e-8ddd-8ed351bf654d
md"# Transportation example"

# ╔═╡ 78be4e6c-eac8-4ee8-ac08-10a861c312b2
md"Dantzig's original transportation model with price-responsiveness on both sides of the market"

# ╔═╡ e07caee3-5407-4764-b248-1378f30c9f1d
begin
...
# ╔═╡ 4155eba3-bd81-47b3-8c38-9d2b5b0a02cc
df = DataFrame(JuMP.Containers.rowtable(value, p; header=[:market, :price]))
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "9cdfb157947847b40625c4532a0179f8ae4d1ba3"
...
[[deps.PATHSolver]]
deps = ["DataDeps", "Libdl", "MathOptInterface", "SparseArrays", "Test"]
git-tree-sha1 = "d13b4ad86c35e2cbc4a6c73ab407261b735b97b3"
